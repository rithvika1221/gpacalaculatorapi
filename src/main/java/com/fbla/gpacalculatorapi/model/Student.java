...
//	private List<Semester> semester;
	 ...
	 * 
	 * @param studentName          * @param studentEmail
	 * @param studentPassword
	 * @param studentWeightedGPA
	 * @param studentUnweightedGPA
	 */
	public Student(String studentName, String studentEmail, String studentPassword, double studentWeightedGPA,
			double studentUnweightedGPA, List<Semester> semester) {
